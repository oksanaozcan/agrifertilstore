    ...
    <div class="container-fluid">
      <div class="row">
        <div class="card card-secondary w-100">
          ...
          <form action="{{ route('admin.customers.filter') }}" method="POST">
            @csrf
            @method('GET')
            <div class="card-body">
              <div class="row mb-3">
      ...
      <div class="row d-flex justify-content-end">
        <a type="button" class="btn btn-primary m-3" href="{{ route('admin.customers.index') }}" >Очистить фильтр</a>
      </div>
