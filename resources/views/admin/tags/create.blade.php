...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Форма для добавления тэга</h1>
        </div>
        ...
        <div class="col-sm-6 mt-2">
          <form action={{ route('admin.tags.store') }} method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="tag_name" aria-describedby="tagNameHelp" placeholder="Введите наименование">
              @error('name')
